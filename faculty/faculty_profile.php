...
<title>Faculty Profile | BCVM</title>
...
<nav class="navbar navbar-inverse navbar-expand-xl navbar-dark">
	<div class="navbar-header d-flex col">
		...
		<a href="faculty_profile.php?logout='1'" class="nav-link" style="color:white;position:absolute;border:2px solid white;border-radius:10px;top:13px;right:15px;padding:3px;width:50px;font-size:20px">&nbsp;&nbsp;<i class="fa fa-sign-out"></i></a>
...
echo "<center><img src='faculty-img/".$row['myimage']."' style='width:150px;height:150px;border-radius:10%;border:3px solid blue;padding:2px;margin:5px'></center>";
}
?>
...
<label>
  ...
  <label>
   &nbsp;&nbsp;Subject :
    <input value="<?php echo $row['subject']; ?>" readonly>
  </label>
  <label>
   &nbsp;&nbsp;Qualification :
    <input value="<?php echo $row['qualification']; ?>" readonly>
  </label>
  <label>
   &nbsp;&nbsp;Location :
...
<a href="student_list.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-list"></i><br>&nbsp;Student Details&nbsp;</a>
</div>
<div style="display:inline-block;border: 3px solid white;border-radius:10px;padding:2px;margin:2px;width:auto;font-size:20px;background-color:#001f3f;">
<a href="student_report.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-book"></i><br>&nbsp;Add Reports&nbsp;</a>
</div>
</div>
</form>
</div>
...
<div class="w3-col m8 w3-right">
<form method="POST" action="" enctype="multipart/form-data" style="border: 3px solid #001f3f;padding:2px;margin:5px">
<center><h3 style="font-size:25px;color:red;width:100%;font-family:Arial"><b>-: Edit Report :-</b></h3></center>
<br>
  <label>
   &nbsp;&nbsp;Student Name :
  ...
  <label>
   &nbsp;&nbsp;Date :
    <input type="text" class="input" name="date" id="in_dob" placeholder="Ex: 29/01/2020" value="<?php echo $row['date']; ?>" required>
    <div class="line-box">
      <div class="line"></div>
    </div>
  ...
  <label>
   &nbsp;&nbsp;Subject :
    <input type="text" class="input" name="subject" placeholder="Ex: English" value="<?php echo $row['subject']; ?>" required>
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
   &nbsp;&nbsp;Full Mark :
    <input type="text" class="input" name="full_mark" placeholder="Ex: 30" value="<?php echo $row['full_mark']; ?>" required>
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
   &nbsp;&nbsp;Mark Obtained :
    <input type="text" class="input" name="mark" placeholder="Ex: 25" value="<?php echo $row['mark']; ?>" required>
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <center><button type="submit" name="edit">update</button>
...
$sql="UPDATE `report_card` SET date='$date' ,subject='$subject' ,full_mark='$full_mark' ,mark='$mark' WHERE id='$eid'";	
...
<form method="POST" action="" enctype="multipart/form-data" style="border: 3px solid #001f3f;padding:2px;margin:5px">
<div style="border: 1px solid #001f3f;padding:2px;margin:5px">
<center><h3 style="font-size:25px;color:red;width:100%;font-family:Arial"><b>-: ALL REPORTS :-</b></h3>
<input type='search' id='myInput' onkeyup='myFunction()' class='light-table-filter' placeholder='Type a student name...' /></center>
<?php
include('connect.php');

$getdata=("SELECT * FROM report_card WHERE faculty_username='".$_SESSION['faculty_username']."' ORDER BY id DESC");
if($result = mysqli_query($db, $getdata) or die (mysqli_error($db)))
if(mysqli_num_rows($result) > 0)
echo "<center>";
echo "<div>";
echo "<div style='overflow-x:auto;'>";
echo "<div style='height:300px;overflow-y:auto;'>";
echo "<table id='myTable' style='padding:2px;margin:5px'>";
...
echo "<td>" . $row['mark'] . "</td>";
echo '<td><a href="faculty_profile.php?id='.$row['id'].'" style="color:black;font-size:25px" name="change"><i class="fa fa-edit"></i></a></td>';
echo "</tr>";
...
// if everything is ok, try to upload file
 ...
 $sql="UPDATE `faculty` SET myimage='$upload_image' WHERE faculty_username='".$_SESSION['faculty_username']."'";	
if($result = mysqli_query($db, $sql))
