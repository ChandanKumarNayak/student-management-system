...
<nav class="navbar navbar-inverse navbar-expand-xl navbar-dark">
	<div class="navbar-header d-flex col">
		...
		<a href="report_card.php?logout='1'" class="nav-link" style="color:white;position:absolute;border:2px solid white;border-radius:10px;top:13px;right:15px;padding:3px;width:50px;font-size:20px">&nbsp;&nbsp;<i class="fa fa-sign-out"></i></a>
...
if(isset($_POST['add'])){
  ...
  $query = "INSERT INTO report_card (student_username,name,year,faculty_name,date,subject,mark,full_mark) 
  			  VALUES('$student_username', '$name', '$year', '$faculty_name', '$date', '$subject', '$mark', '$full_mark')";
  	
	if($result = mysqli_query($db, $query))
		
echo '<meta http-equiv="refresh" content="0;report_card.php" />';
...
echo "<td>" . $row['name'] . "</td>";
echo "<td>" . $row['year'] . "</td>";
echo '<td><a href="report_card.php?id='.$row['id'].'"><p1><i class="fa fa-plus"></i></p1></a></td>';
echo "</tr>";
