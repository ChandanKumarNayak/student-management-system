...
<title>Admin Details | BCVM</title>
...
$getdata=("SELECT * FROM `admin` WHERE id='$eid' AND admin_username='".$_SESSION['admin_username']."'");
...
$sql="UPDATE `admin` SET name='$name' ,email='$email' ,phone='$phone' ,location='$location' WHERE id='$eid' AND admin_username='".$_SESSION['admin_username']."'";	
