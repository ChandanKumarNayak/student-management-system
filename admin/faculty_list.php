...
function did(id)
{
     if(confirm('Sure To Delete This Faculty ?'))
     {
        window.location.href='faculty_list.php?did='+id;
     }
}
</script>
...
<div class="w3-row">
 ...
 <center><h3 style="font-size:25px;color:red;width:100%;font-family:Arial"><b>-: ADD FACULTY :-</b></h3></center>
 
  <label>
   &nbsp;&nbsp;Username :
    <input type="text" class="input" name="faculty_username" placeholder="Ex: chandan134" required>
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
...
echo '<meta http-equiv="refresh" content="0;faculty_list.php" />';
}
?>

<?php
include 'connect.php';
$getdata=("SELECT * FROM faculty ORDER BY id DESC");
...
echo "<form method='POST' action='' enctype='multipart/form-data' style='border: 3px solid #001f3f;padding:2px;margin:5px'>";
  echo "<center>";
  echo "<h3 style='font-size:25px;color:red;width:100%;font-family:Arial'><b>-: FACULTY LIST :-</b></h3>";
  echo "</center>";
...
{
echo "<tr>";
echo "<td><img src='../faculty/faculty-img/".$row['myimage']."' style='width:70px;height:70px;border-radius:5px;margin:5px'></td>";
...
if(isset($_POST['add'])){
  ...
  $query = "INSERT INTO faculty (faculty_username,password) 
  			  VALUES('$faculty_username', '$password')";
