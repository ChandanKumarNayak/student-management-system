...
function did(id)
{
     ...
     {
        window.location.href='admin_list.php?did='+id;
     }
}
</script>
<title>Admin List | BCVM</title>
...
<nav class="navbar navbar-inverse navbar-expand-xl navbar-dark">
	<div class="navbar-header d-flex col">
		...
		<a href="admin_list.php?logout='1'" class="nav-link" style="color:white;position:absolute;border:2px solid white;border-radius:10px;top:13px;right:15px;padding:3px;width:50px;font-size:20px">&nbsp;&nbsp;<i class="fa fa-sign-out"></i></a>
...
<div class="w3-row">
 ...
 <center><h3 style="font-size:25px;color:red;width:100%;font-family:Arial"><b>-: ADD ADMIN :-</b></h3></center>
 
  <label>
   &nbsp;&nbsp;Username :
    <input type="text" class="input" name="admin_username" placeholder="Ex: chandan134" required>
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
   &nbsp;&nbsp;Password :
    <input type="text" class="input" name="password" placeholder="Ex: 12345" required>
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
...
echo '<meta http-equiv="refresh" content="0;admin_list.php" />';
}
?>
...
<?php
include 'connect.php';
$getdata=("SELECT * FROM admin ORDER BY id DESC");
...
echo "<form method='POST' action='' enctype='multipart/form-data' style='border: 3px solid #001f3f;padding:2px;margin:5px'>";
  echo "<center>";
  echo "<h3 style='font-size:25px;color:red;width:100%;font-family:Arial'><b>-: ADMIN LIST :-</b></h3>";
  echo "</center>";
...
{
echo "<tr>";
echo "<td><img src='admin-img/".$row['myimage']."' style='width:70px;height:70px;border-radius:5px;margin:5px'></td>";
...
if(isset($_POST['add'])){
  ...
  $query = "INSERT INTO admin (admin_username,password) 
