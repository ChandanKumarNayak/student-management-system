...
function did(id)
{
     ...
     {
        window.location.href='achievement_back.php?did='+id;
     }
}
</script>
<title>Achievement | BCVM</title>
...
<nav class="navbar navbar-inverse navbar-expand-xl navbar-dark">
	<div class="navbar-header d-flex col">
		...
		<a href="achievement_back.php?logout='1'" class="nav-link" style="color:white;position:absolute;border:2px solid white;border-radius:10px;top:13px;right:15px;padding:3px;width:50px;font-size:20px">&nbsp;&nbsp;<i class="fa fa-sign-out"></i></a>
...
<div class="w3-row">
 ...
 <center><h3 style="font-size:25px;color:red;width:100%;font-family:Arial"><b>-: ADD TOPPER :-</b></h3></center>
 ...
 <label>
  ...
  <label>
   &nbsp;&nbsp;Full Mark (in %) :
    <input type="text" class="input" name="mark" placeholder="Ex: 79.50" required>
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
   &nbsp;&nbsp;Batch :
    <input type="text" class="input" name="batch" placeholder="Ex: 2010-2013" required>
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
...
{
$did=$_GET['did'];
$query = "DELETE FROM achievements WHERE id=$did"; 
if($result = mysqli_query($db, $query))
echo '<meta http-equiv="refresh" content="0;achievement_back.php" />';
}
?>
...
echo "<form method='POST' action='' enctype='multipart/form-data' style='border: 3px solid #001f3f;padding:2px;margin:5px'>";
  echo "<center>";
  echo "<h3 style='font-size:25px;color:red;width:100%;font-family:Arial'><b>-: TOPPER LIST :-</b></h3>";
  echo "</center>";
...
echo "<td><img src='../student/topper-img/".$row['myimage']."' style='width:70px;height:70px;border-radius:5px;margin:5px'></td>";
echo "<td>" . $row['name'] . "</td>";
echo "<td>" . $row['mark'] . "</td>";
...
if(isset($_POST['add'])){
 ...
 if( in_array($imageFileType1,$extensions_arr1) )
  ...
  $query = "INSERT INTO achievements (myimage,name,mark,batch) 
  			  VALUES('$upload_image1', '$name', '$mark', '$batch')";
  	
	if($result = mysqli_query($db, $query))
		
       $folder1="../student/topper-img/";
