...
<nav class="navbar navbar-inverse navbar-expand-xl navbar-dark">
	<div class="navbar-header d-flex col">
		...
		<a href="student_details.php?logout='1'" class="nav-link" style="color:white;position:absolute;border:2px solid white;border-radius:10px;top:13px;right:15px;padding:3px;width:50px;font-size:20px">&nbsp;&nbsp;<i class="fa fa-sign-out"></i></a>
	</div>
</nav>  
...
<label>
  ...
  <label>
   &nbsp;&nbsp;Guardian Name :
    <input type="text" class="input" pattern="^[a-zA-Z\s]+$" name="f_name" placeholder="Ex: Rabindra Nayak" required>
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  ...
  <label>
   &nbsp;&nbsp;Year Of Admission :
    <input type="text" class="input" name="year" placeholder="Ex: 2010" required>
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
...
if(isset($_POST['submit'])){
 ...
 if( in_array($imageFileType1,$extensions_arr1) )
  ...
  $sql="UPDATE `student` SET myimage='$upload_image1' ,name='$name' ,email='$email' ,phone='$phone' ,year='$year' ,f_name='$f_name' ,status='1' WHERE student_username='".$_SESSION['student_username']."'";	
