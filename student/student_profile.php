...
<title>Student Profile | BCVM</title>
...
<nav class="navbar navbar-inverse navbar-expand-xl navbar-dark">
	<div class="navbar-header d-flex col">
		...
		<a href="student_profile.php?logout='1'" class="nav-link" style="color:white;position:absolute;border:2px solid white;border-radius:10px;top:13px;right:15px;padding:3px;width:50px;font-size:20px">&nbsp;&nbsp;<i class="fa fa-sign-out"></i></a>
...
echo "<center><img src='student-img/".$row['myimage']."' style='width:150px;height:150px;border-radius:10%;border:3px solid blue;padding:2px;margin:5px'></center>";
}
?>
...
<label>
  ...
  <label>
    &nbsp;&nbsp;Guardian Name :
    <input value="<?php echo $row['f_name']; ?>" readonly>
  </label>
  <label>
   &nbsp;&nbsp;Email ID :
  ...
  <label>
   &nbsp;&nbsp;Year Of Admission :
    <input value="<?php echo $row['year']; ?>" readonly>
  </label>
						 <?php	}
	?> 
                         </div>
...
<form method="POST" action="" enctype="multipart/form-data" style="border: 3px solid #001f3f;padding:2px;margin:5px">
<div style="border: 1px solid #001f3f;padding:2px;margin:5px">
<center><h3 style="font-size:25px;color:red;width:100%;font-family:Arial"><b>-: STUDENT REPORTS :-</b></h3></center>
<?php
include('connect.php');

$getdata=("SELECT * FROM report_card WHERE student_username='".$_SESSION['student_username']."' ORDER BY id DESC");
if($result = mysqli_query($db, $getdata))
if(mysqli_num_rows($result) > 0)
echo "<center>";
echo "<div>";
...
echo "<td style='color:white;background-color:black;font-size:20px'>" . $row['date'] . "</td>";
echo "<td>" . $row['faculty_name'] . "</td>";
echo "<td>" . $row['subject'] . "</td>";
echo '<td><a href="report_card.php?id='.$row['id'].'" target="_blank" style="color:black;font-size:25px"><i class="fa fa-hand-pointer-o"></i></a></td>';
echo "</tr>";
...
// if everything is ok, try to upload file
 ...
 $sql="UPDATE `student` SET myimage='$upload_image' WHERE student_username='".$_SESSION['student_username']."'";	
